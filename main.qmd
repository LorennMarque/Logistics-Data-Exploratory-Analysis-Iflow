...
> Cantidad de entregas correspondientes a cada cliente
...
print(elbow_plot)
```
El "gráfico del codo" representa el punto donde añadir más clusters no produce una disminución significativa en el WSS, sugiriendo que los clusters ya están suficientemente bien definidos.
...
mapa_leaflet
```
Primera entrega de cada día las cuales se ubican en su mayoría a una gran distancia de las sedes de iFlow analizadas anteriormente.
...
mapa_leaflet
```
Este mapa interactivo proporciona una visualización clara y efectiva de las entregas en un día específico, permitiendo a los usuarios entender rápidamente la distribución geográfica de las entregas, el tiempo entre ellas y la relación con los clientes.
